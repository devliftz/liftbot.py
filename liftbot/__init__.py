...
async def on_ready():
    ...
    print(Center.XCenter(Colorate.Horizontal(Colors.red_to_yellow, f"""
                    ...
                    ╚══════╝╚═╝╚═╝        ╚═╝    ╚═════╝ ╚═════╝ ╚═╝  ╚═╝╚═════╝ 
                                                                         ...
                                                                         """)))
    print(Center.XCenter(Colorate.Horizontal(Colors.red_to_yellow, f"Connected {bot.user.name}#{bot.user.discriminator} | Version: 1.6.2 | Time: {current_dateTime.hour}:{current_dateTime.minute}")))
